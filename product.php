...
<button class="scale-95 active:opacity-80 transition-transform"><span class="material-symbols-outlined" data-icon="search">search</span></button>
...
<h1 class="font-display-xl text-display-xl mb-stack-md">SONIC CORE 2000</h1>
<div class="flex items-center gap-4 mb-stack-lg">
<p class="font-headline-md text-headline-md">$599.00</p>
...
<button class="flex-1 bg-primary text-white font-label-bold py-6 px-12 uppercase tracking-widest hover:bg-slate-800 transition-all active:scale-[0.98]">
                            Add to Cart
                        </button>
<button class="w-20 border border-outline-variant flex items-center justify-center hover:bg-white transition-all">
...
<img alt="Sonic Core 2000" class="w-full h-full object-contain mix-blend-multiply" data-alt="Premium sleek matte black over-ear headphones centered on a soft grey minimalist studio background with elegant side lighting" src="assets/images/img_2127287c.jpg"/>
</div>
...
<img alt="Sound waves" class="self-end h-32 object-contain" data-alt="Abstract visualization of fluid blue sound waves flowing through a dark space with micro-particles and light streaks" src="assets/images/img_e6f86be2.jpg"/>
</div>
<!-- Bento Item 2 -->
